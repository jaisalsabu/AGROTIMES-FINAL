            ...
            if (uph.getText().toString().isEmpty())
              {
               ...
               passok.setError("enter a avlid phone  password");
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://hastalavistaresto.000webhostapp.com/AgroTimes/userlogin.php",
...
admin_btn.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        Intent j= new Intent(getApplicationContext(), sellerregister.class);
        startActivity(j);
    }
});
