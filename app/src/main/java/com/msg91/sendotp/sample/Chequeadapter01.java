...
public class Chequeadapter01 extends RecyclerView.Adapter<Chequeadapter01.ProductViewHolder> {
    ...
    public void onBindViewHolder(final ProductViewHolder holder, int position) {
      final   Cheque01 cheque;   cheque = productLister.get(position);
        ...
        //loading the image
holder.blog0.setText(cheque.getImage());
        Picasso.get().load(cheque.getPrize()).into(holder.date0);
holder.datem0.setText(cheque.getUser());
holder.txtt0.setText(cheque.getStatus());
